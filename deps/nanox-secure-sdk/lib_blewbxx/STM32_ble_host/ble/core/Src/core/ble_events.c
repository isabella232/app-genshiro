...
tBleStatus debug_event_process(uint8_t *buffer_in);
...
const hci_le_meta_events_table_type hci_le_meta_events_table[11] = {
...
const hci_vendor_specific_events_table_type hci_vendor_specific_events_table[44] = {
