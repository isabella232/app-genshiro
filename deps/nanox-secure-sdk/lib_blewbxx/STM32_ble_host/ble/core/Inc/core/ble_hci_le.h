...
/**
  * @brief 
  * @param[out] SuggestedMaxTxOctets 
  * @param[out] SuggestedMaxTxTime 
  * @retval Value indicating success or error code.
*/
...
/**
  * @brief 
  * @param[out] supportedMaxTxOctets 
  * @param[out] supportedMaxTxTime 
  * @param[out] supportedMaxRxOctets 
  * @param[out] supportedMaxRxTime 
  * @retval Value indicating success or error code.
*/
...
/**
  ...
  * Values:
  - 0x0000 ... 0x0EFF
  * @param[out] TX_PHY Transmitter PHY in use for the connection
  * @param[out] RX_PHY Receiver PHY in use for the connection
  * @retval Value indicating success or error code.
*/
...
/**
  ...
  * @param TX_PHYS Preference for TX PHY
  * @param RX_PHYS Preference for RX PHY
  * @retval Value indicating success or error code.
*/
...
/**
  ...
  * @param TX_PHYS Preference for TX PHY
  * @param RX_PHYS Preference for RX PHY
  * @param PHY_options Options for PHYs
  * @retval Value indicating success or error code.
*/
