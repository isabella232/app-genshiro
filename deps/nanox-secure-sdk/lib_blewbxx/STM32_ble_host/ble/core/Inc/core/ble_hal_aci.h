...
another Set TX Power command, or the system reboots.
  * @param En_High_Power Enable High Power mode - Deprecated and ignored  on DORY platform
  * Values:
  - 0x00: Standard Power
  - 0x01: High Power
  * @param PA_Level Power amplifier output level. Output power is indicative and it depends on the PCB layout and associated components.Here values are given at the IC pin
  * Values:
  - 0x00: -40 dBm
  - 0x01: -20.85 dBm
  - 0x02: -19.75 dBm
